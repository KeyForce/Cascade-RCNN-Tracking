...
from MOTDT.utils import bbox as bbox_utils
from MOTDT.utils.log import logger
from MOTDT.models import net_utils
from MOTDT.models.reid.image_part_aligned import Model


def load_reid_model():
    model = Model(n_parts=8)
    model.inp_size = (80, 160)
    ckpt = '/home/wild/Fucu/MOTDT/data/googlenet_part8_all_xavier_ckpt_56.h5'
