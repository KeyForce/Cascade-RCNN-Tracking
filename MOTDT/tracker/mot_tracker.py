...
from MOTDT.utils.nms_wrapper import nms_detections
from MOTDT.utils.log import logger

from MOTDT.tracker import matching
from MOTDT.utils.kalman_filter import KalmanFilter
# from MOTDT.models.classification.classifier import PatchClassifier

from MOTDT.models.reid import load_reid_model, extract_reid_features
...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score, max_n_features=120, from_det=True):
...
class OnlineTracker(object):
    ...
    def __init__(self, min_cls_score=0.3, min_ap_dist=0.6, max_time_lost=70, use_tracking=True, use_refind=True):
    ...
    def update(self, image, tlwhs, det_scores=None):
        ...
        dists = matching.nearest_reid_distance(tracked_stracks, detections, metric='cosine')
        ...
        dists = matching.nearest_reid_distance(self.lost_stracks, detections, metric='cosine')
