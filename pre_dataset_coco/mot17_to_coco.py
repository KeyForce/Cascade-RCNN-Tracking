...
root_path = '/home/omnisky/Bob/coco/MOT17/train/'
# 检测框的ID起始值
...
def convert(label_list, json_file):
    ...
    for label_txt in label_list:                                        #循环标签列表
        ...
        for frame in tqdm(txt_dir.keys()):
            ...
            #复制图片
            # shutil.copyfile(picfile, '/home/omnisky/Bob/coco/coco_mot17/train2017/'+filename)
...
def MOT17_TO_COCO():
    ...
    json_file = '/home/omnisky/Bob/coco/coco_mot17/instances_mot17_train2017.json'
