...
def main():
    outdir = '/home/wild/Fucu/data/train'
    frame_out = os.path.join(outdir, "frame")
    anno_out = os.path.join(outdir, "annotation")
    person_type = ["person"]
    parse_anno_file('/home/wild/Fucu/data/CUHK/ana', '/home/wild/Fucu/data/CUHK', frame_out, anno_out, person_type)
    print("Generating done!")


def test():
    seq_inputdir = "/startdt_data/caltech_pedestrian_dataset"
    vbb_inputdir = "/startdt_data/caltech_pedestrian_dataset/ana"
